							...
							<>
								<div className={styles.farmacia_proxima}>
									<div className={styles.farmacia}>
										...
										<Link
											className={styles.link_farmacia}
											href={`/farmacias/${farmaciaMaisProxima._id}`}
										>
											<TituloFarmacia
												image_url={farmaciaMaisProxima.imagem_url}
											>
								...
								{farmaciasProximasF.length > 0 ? (
									<div className={styles.listagem}>
										...
										{farmaciasProximasF.length >= numFarmacias && (
						...
						{farmaciasEscalaF.length > 0 && (
							<div className={styles.listagem}>
								<>
									...
									{farmaciasEscalaF.length >= numFarmacias && (
